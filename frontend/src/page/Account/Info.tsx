										...
										<div className='PasswordUpdate'>
											<section className='PasswordUpdate__left'>
												<div className='PasswordUpdate__left__old'>
														<input type="text" name="" id="PasswordOld" placeholder=''  
												...
												<div className='PasswordUpdate__left__New'>
														<input type="text" name="" id="PasswordNew" placeholder='' className='PasswordUpdate__left__New__Input'
														onChange={(e) => {
												...
												<div className='PasswordUpdate__left__NewReplay'>
														<input type="text" name="" id="PasswordNewReplay" placeholder='' className='PasswordUpdate__left__NewReplay__Input'
														onChange={(event) => {
